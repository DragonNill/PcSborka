...
namespace PcSborka.Entity
{
    ...
    {
        public static CreatePcForThePeopl_dbEntities DBContext { get; private set; }

        static CreatePcForThePeopl_dbEntities()
        {
            DBContext = new CreatePcForThePeopl_dbEntities();
        }
